...
import { HEALTH_WELLNESS_TIPS, HEALTH_CATEGORIES } from '../constants/healthWellnessData';
...
function HealthWellnessPage() {
  ...
  const filteredTips = selectedCategory === 'all' 
    ...
    : HEALTH_WELLNESS_TIPS.filter(tip => 
        tip.category.toLowerCase().replace(/['\s]/g, '-') === selectedCategory
      );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {filteredTips.map((tip) => (
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  src={`https://images.unsplash.com/photo-${getImageId(tip.category)}?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250&q=80`}
                  alt={tip.title}
        ...
        {filteredTips.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Try selecting a different category to view more health tips.</p>
          </div>
        )}
      </div>
